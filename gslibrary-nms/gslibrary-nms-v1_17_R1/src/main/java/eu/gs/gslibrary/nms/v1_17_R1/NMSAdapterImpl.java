package eu.gs.gslibrary.nms.v1_17_R1;
...
public class NMSAdapterImpl implements NMSAdapter {
    ...
    public Object packetBlockChange(Location l, int blockId, byte blockData) {
        return new PacketPlayOutBlockChange(blockPos(l), Block.getByCombinedId(blockId << 4 | (blockData & 15)));
    }
    ...
    public int getEntityTypeId(EntityType type) {
        return getEntityTypes(type).map(IRegistry.Y::getId).orElse(-1);
    }
